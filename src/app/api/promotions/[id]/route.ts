...
export async function PUT(
  ...
  try {
    ...
    if (body.minOrder !== undefined) updateData.minOrder = body.minOrder ?? null;
    if (body.maxDiscount !== undefined) updateData.maxDiscount = body.maxDiscount ?? null;
...
export async function DELETE(
  ...
  try {
    ...
    const result = await db.promotion.deleteMany({
      where: { id, businessId },
    });
